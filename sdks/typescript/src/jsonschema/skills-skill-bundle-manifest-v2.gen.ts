...
/**
 * Closed Catalog First manifest for bundled and metadata-only YiJie Desktop Skill entries.
 */
export type SkillBundleManifestV2 = ({
[k: string]: unknown
} & {
schema_version: 2
...
catalog_entry_mode?: ("bundled" | "catalog-only")
entrypoint?: "SKILL.md"
icon: Icon
risk: Risk
...
authorization_scope: ("none" | "local-development" | "desktop-distribution")
...
blocked_reason?: ("source_unverified" | "license_unverified" | "distribution_not_authorized" | "security_review_pending" | "capability_unavailable" | "maintenance_ended")
}
